...
\TLV
   ...
   |cpu
      @0
         ...
         $imem_rd_en = ~ $reset;
         //(Discarded after brach predicted valid is implemented)// Valid Signal to Prevent Control and Read Write Hazards
         //$start = ~$reset & >>1$reset;
      ...
      @1   
         ...
         // RV321 Base Instruction Set Decoding (Refer instruction Set)
         ...
         // Hiding Warnings Related to the listed unconnected signals during design
         `BOGUS_USE($is_beq $is_bne $is_blt $is_bge $is_bltu $is_bgeu $is_addi $is_add
                    $is_lui $is_auipc $is_jal $is_jalr $is_load
                    $is_sb $is_sh $is_sw $is_slti $is_sltiu $is_xori $is_ori $is_andi $is_slli $is_srli $is_srai
      ...
      @3
         ...
         $result[31:0] = $is_addi ? $src1_value + $imm :
                         ...
                         $is_srai ? { {32{$src1_value[32]}}, $src1_value} >> $imm[4:0] :
                         ...
                         $is_sra ? { {32{$src1_value[32]}}, $src1_value} >> $src2_value[4:0] :
                         32'bx;
      ...
      @4
         // Connecting the Main Memory
         $dmem_wr_en = $is_s_instr && $valid;
         $dmem_addr[3:0] = $result[5:2];
         $dmem_wr_data[31:0] = $src2_value;
         $dmem_rd_en = $is_load;
         //$dmem_rd_index[5:0] = $rs2;
